...
interface ProjectProps {
  ...
  description: string;
  image: string;
  category: 'WordPress' | 'Next.js' | 'React' | 'All' | 'GoHighLevel' | 'eCommerce';
  techStack: string[];
  status?: 'development' | 'under-development' | 'frontend-only';
  designedBy?: string;
  liveUrl?: string;
...
const ProjectCard: React.FC<ProjectProps> = ({
  ...
  <motion.div
    ...
    className={`group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 ${featured ? 'md:col-span-2' : ''
      }`}
  >
    {/* Featured Badge */}
    {featured && (
...
const ProjectsSection: React.FC = () => {
  ...
  const filters = ['All', 'WordPress', 'Next.js', 'GoHighLevel', 'eCommerce'];
  ...
  const projects: ProjectProps[] = [

    {
      ...
      image: "/projects/wordpress/bdn.png",
      category: "eCommerce",
      techStack: ["eCommerce", "Elementor"],
    ...
    },
    {
      ...
      description: "A modern eCommerce platform with content management, SEO optimization, and social sharing capabilities.",
      image: "/projects/nextJS/mojito.png",
      category: "Next.js",
    ...
    },
    {
      id: 12,
      title: "Librify",
      description: "A professional corporate website built with Next.js, featuring custom themes and advanced functionality.",
    ...
    },
    {
      id: 15,
      title: "Clyde Sports",
      description: "A collaborative sports platform with frontend features built in React and Tailwind CSS.",
    ...
    },
    {
      id: 16,
      title: "Clynime",
      description: "A modern Next.js blog platform with content management, SEO optimization, and social sharing capabilities.",
